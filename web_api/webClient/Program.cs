...
public class OSFWebClient : WebClient
{
    ...
    static void Main(string[] args)
    {
        using (OSFWebClient webClient = new OSFWebClient())
        {
            ...
            string request = "{\"system_call_id\":\"OSF_SYSCALL_ONREGISTER\",\"system_call_data\":{\"product_id\":\"OSF_IPRODUCT_IATAS\",\"data\":{\"on_query_data_url\":\"https://192.168.24.133:4343/officescan_iatas/osf/iatas_api/v1/resourcedata\",\"on_command_data_url\":\"https://192.168.24.133:4343/officescan_iatas/osf/iatas_api/v1/commandhub\",\"on_notify_url\":\"https://192.168.24.133:4343/officescan_iatas/osf/iatas_api/v1/notifyhub\",\"on_log_url\":\"https://192.168.24.133:4343/officescan_iatas/osf/iatas_api/v1/loghub\",\"interested_command_ids\":[{\"cmd_id\":\"OSF_ONCOMMAND_MDR_COMMAND\",\"cmd_type\":\"tmik\"},{\"cmd_id\":\"OSF_ONCOMMAND_MDR_COMMAND\",\"cmd_type\":\"collect_file\"},{\"cmd_id\":\"OSF_ONCOMMAND_MDR_COMMAND\",\"cmd_type\":\"attk_assess\"}],\"reverse_proxy_rules\":[\"https://192.168.24.133:4343/officescan_iatas/Shared/Assessments/GetConfig.ashx\",\"https://192.168.24.133:4343/officescan_iatas/Shared/Assessments/UploadReport.ashx\",\"https://192.168.24.133:4343/officescan_iatas/Shared/Assessments/GetSampleUploadList.ashx\",\"https://192.168.24.133:4343/officescan_iatas/Shared/Forensics/DownloadTmfk.ashx\",\"https://192.168.24.133:4343/officescan_iatas/Shared/Forensics/GetCommand.ashx\",\"https://192.168.24.133:4343/officescan_iatas/Shared/Forensics/GetDedupFileList.ashx\",\"https://192.168.24.133:4343/officescan_iatas/Shared/Forensics/SetCommandStatus.ashx\",\"https://192.168.24.133:4343/officescan_iatas/Shared/Forensics/UploadCollectedFiles.ashx\",\"https://192.168.24.133:4343/officescan_iatas/Shared/Forensics/UploadTmfkReport.ashx\"],\"server_certificate_pem\":\"1111\"}}}";

            Console.WriteLine("request: {0}", request);
            string response = webClient.UploadString("https://192.168.24.133:4343/officescan/osfwebapp/api/v1/SystemCall", "POST", request);
